...
function css_asset_url($asset_name, $module_name = NULL, $user = NULL) {
    if ($user == NULL) {
...
function css_asset($asset_name, $module_name = NULL, $attributes = array(), $user = NULL) {
    ...
    if ($user == NULL) {
        ...
        return '<link href="' . css_asset_url($asset_name, $module_name,$user) . '" rel="stylesheet" type="text/css"' . $attribute_str . ' />';
    }
}
