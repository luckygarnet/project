      ...
      <aside>
          <div class="nav-collapse " id="sidebar" style="overflow: hidden;" tabindex="5000">
              ...
              <ul id="nav-accordion" class="sidebar-menu">
                  ...
                  <p class="centered"><a href="profile.html"><img width="60" class="img-circle" src="<?php echo base_url('assets/img/ui-sam.jpg');?>"></a></p>
              	  <h5 class="centered">Marcel Newman</h5>
              	  	
                  <li class="mt">
                      <a href="<?php echo base_url('index.php/AdminPanel/showCompositAll');?>" class="active">
